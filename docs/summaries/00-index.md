...
- **Recent specs of note**:
  ...
  - Smart-brain: [spec-archetype-cooldown-permanence.md](../specs/smart-brain/spec-archetype-cooldown-permanence.md) — permanent verdict-fail blocks + uniqueness probe + cache peek (latest); [spec-archetype-verdict-cooldown.md](../specs/smart-brain/spec-archetype-verdict-cooldown.md) — original 24h cooldown design; [spec-manual-candidate-override.md](../specs/smart-brain/spec-manual-candidate-override.md) — pinned cache rows for human-verified positives; [spec-element-resolver-ambiguous-cache-write.md](../specs/smart-brain/spec-element-resolver-ambiguous-cache-write.md), [spec-element-resolver-cache-semantic-guard.md](../specs/smart-brain/spec-element-resolver-cache-semantic-guard.md) — cache correctness fixes.
  - Dom-pruner: [spec-dom-pruner-aria-snapshot.md](../specs/dom-pruner/spec-dom-pruner-aria-snapshot.md) — ariaSnapshot-based accessible-name resolution; [spec-empty-name-disambiguation.md](../specs/dom-pruner/spec-empty-name-disambiguation.md) — identifier-attr fallback when accessible name is empty.
  - Workers: [spec-live-run-updates.md](../specs/workers/spec-live-run-updates.md) — step_results.step_id wired through API enqueue → worker so step text shows in the timeline; useRunDetail polls every 2s while a run is in non-terminal status.
