/* global React */
// Minimal stroke icon set. 16px grid, currentColor, 1.5 stroke.

function Icon({ d, size, fill, children, ...rest }) {
  return (
...
// status → color/label/icon mapping used everywhere
const STATUS = {
...
Object.assign(window, { Icon, I, STATUS, StatusBadge, StatusDot });
